...
export function NumberInput({ component, value, onChange, theme, disabled }: ComponentProps) {
  ...
  // Format value hint
  const valueHint = component.min_value !== undefined && component.max_value !== undefined
    ? `${component.min_value} - ${component.max_value}`
    : component.min_value !== undefined
    ? `Min: ${component.min_value}`
    : component.max_value !== undefined
